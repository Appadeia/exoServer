    ...
    def net_cmd_ct(self, args):
        ...
        if args[1].startswith('/'):
            ...
            if self.client.is_mod:
                self.client.area.send_command('CT', '{' + self.client.name + '}', args[1]) #If a mod, surround the username with brackets.
            else:
                self.client.area.send_command('CT', self.client.name, args[1]) #Otherwise, just send as normal.
            logger.log_server(
